...
class _CardScreenState extends State<CardScreen> {
  ...
  Future<void> _updateCard(int id, String currentName, String currentSuit, String currentImageUrl) async {
    TextEditingController nameController = TextEditingController(text: currentName);
    TextEditingController suitController = TextEditingController(text: currentSuit);
